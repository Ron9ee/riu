...
const RiuStep: React.FC<RiuStepProps> = ({ onNext, onSkip, onBack, selectedDesign }) => {
  const [showConnection, setShowConnection] = useState(false);
  const [isConnecting, setIsConnecting] = useState(false);
  const [isConnected, setIsConnected] = useState(false);
  const [connectionError, setConnectionError] = useState('');
  const [customIP, setCustomIP] = useState('riu.local');
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      setConnectionError('Cannot reach Riu. Make sure it\'s powered on and connected to WiFi.');
    } finally {
        ...
        <div className="space-y-6 relative">
          ...
          <div className="text-center space-y-2 pt-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-semibold mb-2">
              ...
              Step 1: Connect Your Riu
            </div>
            <h2 className="text-2xl font-bold">Meet Your Desk Companion</h2>
            <p className="text-muted-foreground max-w-md mx-auto text-sm">
              Watch how Riu works, then connect it to get started
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-card border rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="relative aspect-video bg-black">
                ...
                >
                  <source src="/riu-demo.mp4" type="video/mp4" />
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600">
                  <div className="text-center text-white space-y-4 p-6">
                    ...
                    <div className="text-lg font-semibold">Riu Demo Video</div>
                    <div className="text-sm opacity-90">
                      Add your riu-demo.mp4 to /public folder
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-card border-2 border-black rounded-[24px] overflow-hidden shadow-[6px_6px_0_0_rgba(0,0,0,1)] dark:shadow-[6px_6px_0_0_rgba(0,0,0,0.6)]">
            ...
            <div className="relative aspect-video bg-black">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600">
                <div className="text-center text-white space-y-4 p-6">
                  <div className="text-6xl">🎬</div>
                  <div className="text-lg font-black">Riu Demo Video</div>
    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <h2 className="text-2xl font-bold">
          {isConnected ? 'Connected!' : 'Connect Your Riu'}
        </h2>
        <p className="text-muted-foreground">
          {isConnected 
            ? 'Your Riu is ready to assist you' 
            : 'Make sure Riu is powered on and connected to WiFi'
          }
        </p>
      </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm space-y-2">
                ...
                <ol className="list-decimal list-inside space-y-1 text-xs">
                  <li>First time? Connect to "Riu-Setup" WiFi</li>
                  <li>Visit riu.local to configure your home WiFi</li>
                  <li>Wait for Riu to connect (check OLED display)</li>
