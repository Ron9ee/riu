  ...
  return (
    <div className="p-8 text-center">
      <div className={
        ...
        <p className={theme === 'retro' ? "text-muted-foreground font-medium" : "text-muted-foreground"}>Connect Google Calendar, Slack, and other services to get notified on Riu. Coming soon</p>
      </div>
    </div>
  );
};
