...
interface CategorySidebarProps {
  currentPage: 'dashboard' | 'tasks' | 'reminders' | 'events' | 'notifications' | 'pomodoro' | 'notes' | 'activity' | 'timetracking' | 'settings' | 'riu' | 'schedule';
  onPageChange: (page: 'dashboard' | 'tasks' | 'reminders' | 'events' | 'notifications' | 'pomodoro' | 'notes' | 'activity' | 'timetracking' | 'settings' | 'riu' | 'schedule') => void;
  currentView?: 'today' | 'tomorrow' | 'next7days' | 'completed' | string; 
  onViewChange?: (view: 'today' | 'tomorrow' | 'next7days' | 'completed' | string) => void; 
  activityStats?: {
        ...
        >
          <div className="flex items-center gap-2 flex-1">
            ...
            <div className="flex-1">
              <div className="font-semibold text-sm">Riu</div>
      ...
      <SidebarContent>
        ...
        <SidebarGroup className={theme === 'retro' ? "mt-2" : ""}>
          ...
          <SidebarMenu className={theme === 'retro' ? "gap-3" : ""}>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton
                onClick={() => onPageChange('riu')}
                isActive={currentPage === 'riu'}
                className={
                  theme === 'retro' && currentPage === 'riu'
