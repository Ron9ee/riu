...
const RetroTodoCard: React.FC<RetroTodoCardProps> = ({
  ...
  const getDarkModeColor = () => {
    ...
    const colorMap: { [key: string]: string } = {
      '#ffe164': 'dark:!bg-yellow-700',     
      '#96f2d7': 'dark:!bg-teal-700',       
      '#ffd4f4': 'dark:!bg-pink-700',       
      '#d4f1ff': 'dark:!bg-blue-700',       
      '#fff3b0': 'dark:!bg-yellow-600',     
      '#3B82F6': 'dark:!bg-blue-700',       
      '#10B981': 'dark:!bg-emerald-700',    
      '#F59E0B': 'dark:!bg-amber-700',      
      '#EF4444': 'dark:!bg-red-700',        
      '#8B5CF6': 'dark:!bg-violet-700',     
      '#06B6D4': 'dark:!bg-cyan-700',       
      '#EC4899': 'dark:!bg-pink-700',       
      '#84CC16': 'dark:!bg-lime-700',       
      '#F97316': 'dark:!bg-orange-700',     
      '#14B8A6': 'dark:!bg-teal-700',       
      '#6366F1': 'dark:!bg-indigo-700',     
      '#A855F7': 'dark:!bg-purple-700',     
      '#EAB308': 'dark:!bg-yellow-700',     
      '#22C55E': 'dark:!bg-green-700',      
      '#F43F5E': 'dark:!bg-rose-700',       
    };
