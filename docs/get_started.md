...
```bash
git clone https://github.com/Ron9ee/riu.git
cd riu
```

**Option B: Download as ZIP**

- Go to https://github.com/Ron9ee/riu
...
3. **Watch the magic!** Riu should start showing its idle animation

**Tip:** Sometimes things just break, so disconnect riu for a few seconds and plug back in if wifi is not connecting properly. 
...
Riu will show focus, happy,relax and bored animations a long the way to keep you focused.
...
If this helped you, consider giving the project a star on [GitHub](https://github.com/Ron9ee/riu)!
