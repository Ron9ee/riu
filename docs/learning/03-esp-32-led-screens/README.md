...
Exported chat to D:\riu 

# 4. ESP32 + GME12864-11 + lopaka.app + send faces

The goal now is to see whether for battery safety and not using rasberypie to use esp32 as just sort of middle maschine as I dont want to use rasberypie and some weird large batteries to Riu.
...
A real pain in the ass to make it as easy as possible for someone to connect their riu and ran into a bunch of bugs when setting the thing up with a new esp32 which is good to learn now 
